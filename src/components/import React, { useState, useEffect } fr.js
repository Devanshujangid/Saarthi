  ...
  return (
    <>
      ...
      <div className="fixed top-4 right-6 z-50">
        <button
          onClick={openModal}
          className="!px-4 !py-1.5 !rounded-full border !border-green-600 !text-black font-semibold !bg-white hover:bg-green-50 transition shadow-sm"
        >
          Sign In
        </button>
      </div>

      {/* Render SignInForm Modal using reusable Modal component */}
      {isModalOpen && (
